...
namespace ESO_Lang_Editor.Model
{
    class IDCatalog
    {
        ...
        private void InitFileidToCategory()
        {
            ...
            fileidToCategory.Add("19709733", "等级解锁奖励（副本名）");
            fileidToCategory.Add("146361138", "大地图地标名");
            fileidToCategory.Add("157886597", "战场地标");
            fileidToCategory.Add("162946485", "location-and-object");
            fileidToCategory.Add("164009093", "地点（按E互动）");
            fileidToCategory.Add("19398485", "互动物品（按E）");
            fileidToCategory.Add("211899940", "location-and-object");
            fileidToCategory.Add("219936053", "采集调查地点（按E互动）");
            ...
            fileidToCategory.Add("8290981", "NPC名字");
            fileidToCategory.Add("165399380", "NPC谈话");
            ...
            fileidToCategory.Add("33425332", "邮件寄件人名（NPC）");
            fileidToCategory.Add("51188660", "NPC名（变量代码）");
