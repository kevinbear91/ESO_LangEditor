    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginUserDto loginUser)
        {
            ...
            if (user == null)
            {
                ...
                _logger.LogInformation(RespondCode.UserNotFound.ApiRespondCodeString());
            ...
            if (await _userManager.IsLockedOutAsync(user))
            {
                return BadRequest(new MessageWithCode
                {
                    ...
                    Message = RespondCode.UserLocked.ApiRespondCodeString()
                });
            }
...

            {
                ...
                return Unauthorized(new MessageWithCode
                {
                    ...
                    Message = RespondCode.PasswordNotMatch.ApiRespondCodeString()
                });
            }
        ...
        public async Task<IActionResult> RefreshToken(string userId, TokenDto tokenDto)
        {
            ...
            if (user.RefreshToken == null || user.RefreshTokenExpireTime == null)
            {
                return BadRequest(new MessageWithCode
                {
                    ...
                    Message = RespondCode.TokenInvalid.ApiRespondCodeString()
                });
            }
            ...
            if (!isRegCodeExist)
            {
                ...
                else
                {
                    return BadRequest(new MessageWithCode
                    {
                        ...
                        Message = RespondCode.GenerateRegistrationCodeFailed.ApiRespondCodeString()
                    });
                }
        ...
        public async Task<IActionResult> RegisterUser(RegistrationUserDto registrationUserDto)
        {
            ...
            if (isExistUser != null)
            {
                return BadRequest(new MessageWithCode
                {
                    ...
                    Message = RespondCode.UserNameExisted.ApiRespondCodeString()
                });
            }
            ...
            if (regCode == null || regCode.UserUsed != null)
            {
                return BadRequest(new MessageWithCode
                {
                    ...
                    Message = RespondCode.RegistrationCodeInvalid.ApiRespondCodeString()
                });
            }
            ...
            else
            {
                return BadRequest(new MessageWithCode
                {
                    ...
                    Message = RespondCode.UserRegistrationFailed.ApiRespondCodeString()
                });
            }
        }
