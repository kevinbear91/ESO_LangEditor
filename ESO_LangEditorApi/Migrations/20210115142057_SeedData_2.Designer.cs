...
namespace ESO_LangEditor.API.Migrations
{
    ...
    [Migration("20210115142057_SeedData_2")]
            ...
            modelBuilder.Entity("ESO_LangEditor.Core.Entities.LangText", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsTranslated = (byte)2,
                            LangTextType = (byte)4,
                            ReviewTimestamp = new DateTime(2021, 1, 15, 22, 20, 56, 711, DateTimeKind.Local).AddTicks(1210),
                        ...
                        new
                        {
                            ...
                            IsTranslated = (byte)2,
                            LangTextType = (byte)4,
                            ReviewTimestamp = new DateTime(2021, 1, 15, 22, 20, 56, 711, DateTimeKind.Local).AddTicks(2075),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
                        ...
                        new
                        {
                            ...
                            IsTranslated = (byte)2,
                            LangTextType = (byte)4,
                            ReviewTimestamp = new DateTime(2021, 1, 15, 22, 20, 56, 711, DateTimeKind.Local).AddTicks(2113),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
                        ...
                        new
                        {
                            ...
                            IsTranslated = (byte)2,
                            LangTextType = (byte)4,
                            ReviewTimestamp = new DateTime(2021, 1, 15, 22, 20, 56, 711, DateTimeKind.Local).AddTicks(2133),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
                        ...
                        new
                        {
                            ...
                            IsTranslated = (byte)2,
                            LangTextType = (byte)4,
                            ReviewTimestamp = new DateTime(2021, 1, 15, 22, 20, 56, 711, DateTimeKind.Local).AddTicks(2151),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
                        ...
                        new
                        {
                            ...
                            IsTranslated = (byte)2,
                            LangTextType = (byte)4,
                            ReviewTimestamp = new DateTime(2021, 1, 15, 22, 20, 56, 711, DateTimeKind.Local).AddTicks(2168),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
                        ...
                        new
                        {
                            ...
                            IsTranslated = (byte)2,
                            LangTextType = (byte)4,
                            ReviewTimestamp = new DateTime(2021, 1, 15, 22, 20, 56, 711, DateTimeKind.Local).AddTicks(2185),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
                            TextEn = "Za'ji^M",
                        ...
                        new
                        {
                            ...
                            IsTranslated = (byte)2,
                            LangTextType = (byte)4,
                            ReviewTimestamp = new DateTime(2021, 1, 15, 22, 20, 56, 711, DateTimeKind.Local).AddTicks(2201),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
                        ...
                        new
                        {
                            ...
                            IsTranslated = (byte)2,
                            LangTextType = (byte)3,
                            ReviewTimestamp = new DateTime(2021, 1, 15, 22, 20, 56, 711, DateTimeKind.Local).AddTicks(2218),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
            ...
            modelBuilder.Entity("ESO_LangEditor.Core.Entities.LangTextArchive", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ArchiveTimestamp = new DateTime(2021, 1, 15, 22, 20, 56, 713, DateTimeKind.Local).AddTicks(1728),
                            EnLastModifyTimestamp = new DateTime(2020, 11, 2, 21, 48, 38, 613, DateTimeKind.Unspecified).AddTicks(4703),
                            IdType = 103224356,
                            IsTranslated = (byte)2,
                            LangTextType = (byte)4,
                            ReviewTimestamp = new DateTime(2021, 1, 15, 22, 20, 56, 713, DateTimeKind.Local).AddTicks(1074),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
                        ...
                        new
                        {
                            ...
                            ArchiveTimestamp = new DateTime(2021, 1, 15, 22, 20, 56, 713, DateTimeKind.Local).AddTicks(2472),
                            EnLastModifyTimestamp = new DateTime(2020, 11, 2, 21, 48, 38, 626, DateTimeKind.Unspecified).AddTicks(4609),
                            IdType = 139139780,
                            IsTranslated = (byte)2,
                            LangTextType = (byte)4,
                            ReviewTimestamp = new DateTime(2021, 1, 15, 22, 20, 56, 713, DateTimeKind.Local).AddTicks(2459),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
                        ...
                        new
                        {
                            ...
                            ArchiveTimestamp = new DateTime(2021, 1, 15, 22, 20, 56, 713, DateTimeKind.Local).AddTicks(2504),
                            EnLastModifyTimestamp = new DateTime(2020, 11, 2, 21, 48, 38, 673, DateTimeKind.Unspecified).AddTicks(397),
                            IdType = 115740052,
                            IsTranslated = (byte)2,
                            LangTextType = (byte)4,
                            ReviewTimestamp = new DateTime(2021, 1, 15, 22, 20, 56, 713, DateTimeKind.Local).AddTicks(2501),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
            ...
            modelBuilder.Entity("ESO_LangEditor.Core.Entities.LangTextReview", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsTranslated = (byte)2,
                            LangTextType = (byte)3,
                            ReviewTimestamp = new DateTime(2021, 1, 15, 22, 20, 56, 712, DateTimeKind.Local).AddTicks(7862),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
                            TextEn = "Destruction Staff",
                            TextId = "SI_EQUIPMENTFILTERTYPE9",
                            TextZh = "毁灭法杖",
                        ...
                        new
                        {
                            ...
                            IsTranslated = (byte)2,
                            LangTextType = (byte)2,
                            ReviewTimestamp = new DateTime(2021, 1, 15, 22, 20, 56, 712, DateTimeKind.Local).AddTicks(8648),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
                            TextEn = "All Materials",
                            TextId = "SI_GAMEPAD_ALCHEMY_ALL_MATERIALS",
                            TextZh = "所有材料",
                        ...
                        new
                        {
                            ...
                            IsTranslated = (byte)2,
                            LangTextType = (byte)4,
                            ReviewTimestamp = new DateTime(2021, 1, 15, 22, 20, 56, 712, DateTimeKind.Local).AddTicks(8685),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
                            TextEn = "Dungeon: Selene's Web",
                            TextId = "10860933-0-964",
                            TextZh = "组队副本：瑟琳之网",
