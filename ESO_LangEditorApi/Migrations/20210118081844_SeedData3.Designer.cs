...
namespace ESO_LangEditor.API.Migrations
{
    ...
    [Migration("20210118081844_SeedData3")]
            ...
            modelBuilder.Entity("ESO_LangEditor.Core.Entities.LangText", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsTranslated = (byte)2,
                            LangTextType = (byte)4,
                            ReviewTimestamp = new DateTime(2021, 1, 18, 16, 18, 43, 683, DateTimeKind.Local).AddTicks(4095),
                        ...
                        new
                        {
                            ...
                            IsTranslated = (byte)2,
                            LangTextType = (byte)4,
                            ReviewTimestamp = new DateTime(2021, 1, 18, 16, 18, 43, 683, DateTimeKind.Local).AddTicks(4947),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
                        ...
                        new
                        {
                            ...
                            IsTranslated = (byte)2,
                            LangTextType = (byte)4,
                            ReviewTimestamp = new DateTime(2021, 1, 18, 16, 18, 43, 683, DateTimeKind.Local).AddTicks(4984),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
                        ...
                        new
                        {
                            ...
                            IsTranslated = (byte)2,
                            LangTextType = (byte)4,
                            ReviewTimestamp = new DateTime(2021, 1, 18, 16, 18, 43, 683, DateTimeKind.Local).AddTicks(5003),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
                        ...
                        new
                        {
                            ...
                            IsTranslated = (byte)2,
                            LangTextType = (byte)4,
                            ReviewTimestamp = new DateTime(2021, 1, 18, 16, 18, 43, 683, DateTimeKind.Local).AddTicks(5021),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
                        ...
                        new
                        {
                            ...
                            IsTranslated = (byte)2,
                            LangTextType = (byte)4,
                            ReviewTimestamp = new DateTime(2021, 1, 18, 16, 18, 43, 683, DateTimeKind.Local).AddTicks(5038),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
                        ...
                        new
                        {
                            ...
                            IsTranslated = (byte)2,
                            LangTextType = (byte)4,
                            ReviewTimestamp = new DateTime(2021, 1, 18, 16, 18, 43, 683, DateTimeKind.Local).AddTicks(5055),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
                            TextEn = "Za'ji^M",
                        ...
                        new
                        {
                            ...
                            IsTranslated = (byte)2,
                            LangTextType = (byte)4,
                            ReviewTimestamp = new DateTime(2021, 1, 18, 16, 18, 43, 683, DateTimeKind.Local).AddTicks(5072),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
                        ...
                        new
                        {
                            ...
                            IsTranslated = (byte)2,
                            LangTextType = (byte)3,
                            ReviewTimestamp = new DateTime(2021, 1, 18, 16, 18, 43, 683, DateTimeKind.Local).AddTicks(5090),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
            ...
            modelBuilder.Entity("ESO_LangEditor.Core.Entities.LangTextArchive", b =>
                {
                    ...
                    b.Property<int>("ArchiveReasonFor")
                        .HasColumnType("integer");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ArchiveReasonFor = 0,
                            ArchiveTimestamp = new DateTime(2021, 1, 18, 16, 18, 43, 685, DateTimeKind.Local).AddTicks(5388),
                            EnLastModifyTimestamp = new DateTime(2020, 11, 2, 21, 48, 38, 613, DateTimeKind.Unspecified).AddTicks(4703),
                            IdType = 103224356,
                            IsTranslated = (byte)2,
                            LangTextType = (byte)4,
                            ReviewTimestamp = new DateTime(2021, 1, 18, 16, 18, 43, 685, DateTimeKind.Local).AddTicks(4722),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
                        ...
                        new
                        {
                            ...
                            ArchiveReasonFor = 0,
                            ArchiveTimestamp = new DateTime(2021, 1, 18, 16, 18, 43, 685, DateTimeKind.Local).AddTicks(6146),
                            EnLastModifyTimestamp = new DateTime(2020, 11, 2, 21, 48, 38, 626, DateTimeKind.Unspecified).AddTicks(4609),
                            IdType = 139139780,
                            IsTranslated = (byte)2,
                            LangTextType = (byte)4,
                            ReviewTimestamp = new DateTime(2021, 1, 18, 16, 18, 43, 685, DateTimeKind.Local).AddTicks(6132),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
                        ...
                        new
                        {
                            ...
                            ArchiveReasonFor = 0,
                            ArchiveTimestamp = new DateTime(2021, 1, 18, 16, 18, 43, 685, DateTimeKind.Local).AddTicks(6179),
                            EnLastModifyTimestamp = new DateTime(2020, 11, 2, 21, 48, 38, 673, DateTimeKind.Unspecified).AddTicks(397),
                            IdType = 115740052,
                            IsTranslated = (byte)2,
                            LangTextType = (byte)4,
                            ReviewTimestamp = new DateTime(2021, 1, 18, 16, 18, 43, 685, DateTimeKind.Local).AddTicks(6177),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
            ...
            modelBuilder.Entity("ESO_LangEditor.Core.Entities.LangTextReview", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LangTextType = (byte)3,
                            ReasonFor = 0,
                            ReviewTimestamp = new DateTime(2021, 1, 18, 16, 18, 43, 685, DateTimeKind.Local).AddTicks(1500),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
                            TextEn = "Destruction Staff",
                            TextId = "SI_EQUIPMENTFILTERTYPE9",
                            TextZh = "毁灭法杖",
                        ...
                        new
                        {
                            ...
                            LangTextType = (byte)2,
                            ReasonFor = 0,
                            ReviewTimestamp = new DateTime(2021, 1, 18, 16, 18, 43, 685, DateTimeKind.Local).AddTicks(2274),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
                            TextEn = "All Materials",
                            TextId = "SI_GAMEPAD_ALCHEMY_ALL_MATERIALS",
                            TextZh = "所有材料",
                        ...
                        new
                        {
                            ...
                            LangTextType = (byte)4,
                            ReasonFor = 0,
                            ReviewTimestamp = new DateTime(2021, 1, 18, 16, 18, 43, 685, DateTimeKind.Local).AddTicks(2309),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
                            TextEn = "Dungeon: Selene's Web",
                            TextId = "10860933-0-964",
                            TextZh = "组队副本：瑟琳之网",
