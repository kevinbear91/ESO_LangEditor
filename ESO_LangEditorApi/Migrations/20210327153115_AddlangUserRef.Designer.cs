...
namespace ESO_LangEditor.API.Migrations
{
    ...
    [Migration("20210327153115_AddlangUserRef")]
    partial class AddlangUserRef
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ESO_LangEditor.Core.Entities.LangText", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsTranslated = (byte)2,
                            LangTextType = (byte)4,
                            ReviewTimestamp = new DateTime(2021, 3, 27, 23, 31, 15, 90, DateTimeKind.Local).AddTicks(3497),
                        ...
                        new
                        {
                            ...
                            IsTranslated = (byte)2,
                            LangTextType = (byte)4,
                            ReviewTimestamp = new DateTime(2021, 3, 27, 23, 31, 15, 90, DateTimeKind.Local).AddTicks(4743),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
                        ...
                        new
                        {
                            ...
                            IsTranslated = (byte)2,
                            LangTextType = (byte)4,
                            ReviewTimestamp = new DateTime(2021, 3, 27, 23, 31, 15, 90, DateTimeKind.Local).AddTicks(4781),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
                        ...
                        new
                        {
                            ...
                            IsTranslated = (byte)2,
                            LangTextType = (byte)4,
                            ReviewTimestamp = new DateTime(2021, 3, 27, 23, 31, 15, 90, DateTimeKind.Local).AddTicks(4799),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
                        ...
                        new
                        {
                            ...
                            IsTranslated = (byte)2,
                            LangTextType = (byte)4,
                            ReviewTimestamp = new DateTime(2021, 3, 27, 23, 31, 15, 90, DateTimeKind.Local).AddTicks(4816),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
                        ...
                        new
                        {
                            ...
                            IsTranslated = (byte)2,
                            LangTextType = (byte)4,
                            ReviewTimestamp = new DateTime(2021, 3, 27, 23, 31, 15, 90, DateTimeKind.Local).AddTicks(4832),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
                        ...
                        new
                        {
                            ...
                            IsTranslated = (byte)2,
                            LangTextType = (byte)4,
                            ReviewTimestamp = new DateTime(2021, 3, 27, 23, 31, 15, 90, DateTimeKind.Local).AddTicks(4848),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
                            TextEn = "Za'ji^M",
                        ...
                        new
                        {
                            ...
                            IsTranslated = (byte)2,
                            LangTextType = (byte)4,
                            ReviewTimestamp = new DateTime(2021, 3, 27, 23, 31, 15, 90, DateTimeKind.Local).AddTicks(4864),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
                        ...
                        new
                        {
                            ...
                            IsTranslated = (byte)2,
                            LangTextType = (byte)3,
                            ReviewTimestamp = new DateTime(2021, 3, 27, 23, 31, 15, 90, DateTimeKind.Local).AddTicks(4879),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
            ...
            modelBuilder.Entity("ESO_LangEditor.Core.Entities.LangTextArchive", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ArchiveTimestamp = new DateTime(2021, 3, 27, 23, 31, 15, 92, DateTimeKind.Local).AddTicks(4712),
                            EnLastModifyTimestamp = new DateTime(2020, 11, 2, 21, 48, 38, 613, DateTimeKind.Unspecified).AddTicks(4703),
                            IdType = 103224356,
                            IsTranslated = (byte)2,
                            LangTextType = (byte)4,
                            ReasonFor = 0,
                            ReviewTimestamp = new DateTime(2021, 3, 27, 23, 31, 15, 92, DateTimeKind.Local).AddTicks(4064),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
                        ...
                        new
                        {
                            ...
                            ArchiveTimestamp = new DateTime(2021, 3, 27, 23, 31, 15, 92, DateTimeKind.Local).AddTicks(5452),
                            EnLastModifyTimestamp = new DateTime(2020, 11, 2, 21, 48, 38, 626, DateTimeKind.Unspecified).AddTicks(4609),
                            IdType = 139139780,
                            IsTranslated = (byte)2,
                            LangTextType = (byte)4,
                            ReasonFor = 0,
                            ReviewTimestamp = new DateTime(2021, 3, 27, 23, 31, 15, 92, DateTimeKind.Local).AddTicks(5438),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
                        ...
                        new
                        {
                            ...
                            ArchiveTimestamp = new DateTime(2021, 3, 27, 23, 31, 15, 92, DateTimeKind.Local).AddTicks(5485),
                            EnLastModifyTimestamp = new DateTime(2020, 11, 2, 21, 48, 38, 673, DateTimeKind.Unspecified).AddTicks(397),
                            IdType = 115740052,
                            IsTranslated = (byte)2,
                            LangTextType = (byte)4,
                            ReasonFor = 0,
                            ReviewTimestamp = new DateTime(2021, 3, 27, 23, 31, 15, 92, DateTimeKind.Local).AddTicks(5483),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
            ...
            modelBuilder.Entity("ESO_LangEditor.Core.Entities.LangTextReview", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LangTextType = (byte)3,
                            ReasonFor = 0,
                            ReviewTimestamp = new DateTime(2021, 3, 27, 23, 31, 15, 92, DateTimeKind.Local).AddTicks(917),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
                            TextEn = "Destruction Staff",
                            TextId = "SI_EQUIPMENTFILTERTYPE9",
                            TextZh = "毁灭法杖",
                        ...
                        new
                        {
                            ...
                            LangTextType = (byte)2,
                            ReasonFor = 0,
                            ReviewTimestamp = new DateTime(2021, 3, 27, 23, 31, 15, 92, DateTimeKind.Local).AddTicks(1679),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
                            TextEn = "All Materials",
                            TextId = "SI_GAMEPAD_ALCHEMY_ALL_MATERIALS",
                            TextZh = "所有材料",
                        ...
                        new
                        {
                            ...
                            LangTextType = (byte)4,
                            ReasonFor = 0,
                            ReviewTimestamp = new DateTime(2021, 3, 27, 23, 31, 15, 92, DateTimeKind.Local).AddTicks(1713),
                            ReviewerId = new Guid("8475b578-80f4-4ed0-ae41-c32a45d6d9e6"),
                            TextEn = "Dungeon: Selene's Web",
                            TextId = "10860933-0-964",
                            TextZh = "组队副本：瑟琳之网",
            ...
            modelBuilder.Entity("ESO_LangEditor.Core.Entities.LangText", b =>
                {
                    b.HasOne("ESO_LangEditor.Core.Entities.User", "User")
                        .WithMany()
